          ...
          <MDBRow>
            <MDBCol md='10' lg='6' className='order-2 order-lg-1 d-flex flex-column align-items-center'>
              ...
              <div className="d-flex flex-row align-items-center mb-4">
                ...
                <input  value={name} onChange={e=>setName(e.target.value)} placeholder='Enter Book Name'  type='text' size={25} style={{height:'40px', borderRadius:'10px'}}/>
              </div>

              <div className="d-flex flex-row align-items-center mb-4">
                <label style={{fontSize:'20px',marginRight:'20px'}} htmlFor="name">ISBN Number : </label>
                <input  value={isbnNumber} onChange={e=>setIsbnNumber(e.target.value)} placeholder='ISBN Number' width={'300px'} type='number' size={30} style={{height:'40px', borderRadius:'10px'}}/>
              </div>

              <div className="d-flex flex-row align-items-center mb-4">
                <label style={{fontSize:'20px',marginRight:'20px'}} htmlFor="name">Book Price : </label>
                <input  value={price} onChange={e=>setPrice(e.target.value)} placeholder='Enter the price'  type='number' size={30} style={{height:'40px', borderRadius:'10px'}}/>
              </div>
